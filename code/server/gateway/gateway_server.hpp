#include "redis_operations.hpp" // redis数据管理客户端封装
...
{
// 用户服务相关接口
#define GET_PHONE_VERIFY_CODE "/service/user/get_phone_verify_code" // 获取手机验证码
#define USERNAME_REGISTER "/service/user/username_register"         // 用户名注册
#define USERNAME_LOGIN "/service/user/username_login"               // 用户名登录
#define PHONE_REGISTER "/service/user/phone_register"               // 手机号注册
#define PHONE_LOGIN "/service/user/phone_login"                     // 手机号登录
#define GET_USERINFO "/service/user/get_user_info"                  // 获取用户信息
#define SET_USER_AVATAR "/service/user/set_avatar"                  // 设置用户头像
#define SET_USER_NICKNAME "/service/user/set_nickname"              // 设置用户昵称
#define SET_USER_DESC "/service/user/set_description"               // 设置用户描述
#define SET_USER_PHONE "/service/user/set_phone"                    // 修改用户手机号码

// 好友服务相关接口
#define FRIEND_GET_LIST "/service/friend/get_friend_list"                 // 获取好友列表
#define FRIEND_APPLY "/service/friend/add_friend_apply"                   // 申请添加好友
#define FRIEND_APPLY_PROCESS "/service/friend/add_friend_process"         // 处理好友申请
#define FRIEND_REMOVE "/service/friend/remove_friend"                     // 移除好友
#define FRIEND_SEARCH "/service/friend/search_friend"                     // 搜索好友
#define FRIEND_GET_PENDING_EV "/service/friend/get_pending_friend_events" // 获取好友申请事件

// 聊天会话服务相关接口
#define CSS_GET_LIST "/service/friend/get_chat_session_list"     // 获取聊天会话列表
#define CSS_CREATE "/service/friend/create_chat_session"         // 创建聊天会话
#define CSS_GET_MEMBER "/service/friend/get_chat_session_member" // 获取聊天会话成员

// 消息存储服务相关接口
#define MSG_GET_RANGE "/service/message_storage/get_history"     // 获取消息历史（按范围）
#define MSG_GET_RECENT "/service/message_storage/get_recent"     // 获取最近消息
#define MSG_KEY_SEARCH "/service/message_storage/search_history" // 关键词搜索消息历史

// 消息传输服务相关接口
#define NEW_MESSAGE "/service/message_transmit/new_message" // 发送新消息

// 文件服务相关接口
#define FILE_GET_SINGLE "/service/file/get_single_file" // 获取单个文件
#define FILE_GET_MULTI "/service/file/get_multi_file"   // 获取多个文件
#define FILE_PUT_SINGLE "/service/file/put_single_file" // 上传单个文件
#define FILE_PUT_MULTI "/service/file/put_multi_file"   // 上传多个文件

// 语音识别服务相关接口
#define SPEECH_RECOGNITION "/service/speech/recognition" // 语音识别
    ...
    private:
        ...
        void GetFriendList(const httplib::Request &request, httplib::Response &response)
        {
            ...
            chat_ns::FriendService_Stub stub(channel.get());
            brpc::Controller cntl;
        ...
        void SpeechRecognition(const httplib::Request &request, httplib::Response &response)
        {
            ...
            chat_ns::SpeechService_Stub stub(channel.get());
            brpc::Controller cntl;
        ...
        void NewMessage(const httplib::Request &request, httplib::Response &response)
        {
            ...
            chat_ns::MsgTransmitService_Stub stub(channel.get());
            brpc::Controller cntl;
