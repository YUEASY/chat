...
PROTOBUF_NAMESPACE_OPEN
template<> ::chat_ns::ClientAuthenticationReq* Arena::CreateMaybeMessage<::chat_ns::ClientAuthenticationReq>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace chat_ns {
...
class ClientAuthenticationReq final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:chat_ns.ClientAuthenticationReq) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "chat_ns.ClientAuthenticationReq";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:chat_ns.ClientAuthenticationReq)
 private:
  class _Internal;
...
inline const std::string& ClientAuthenticationReq::request_id() const {
  // @@protoc_insertion_point(field_get:chat_ns.ClientAuthenticationReq.request_id)
...
void ClientAuthenticationReq::set_request_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.request_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:chat_ns.ClientAuthenticationReq.request_id)
}
inline std::string* ClientAuthenticationReq::mutable_request_id() {
  std::string* _s = _internal_mutable_request_id();
  // @@protoc_insertion_point(field_mutable:chat_ns.ClientAuthenticationReq.request_id)
  return _s;
}
...
inline std::string* ClientAuthenticationReq::release_request_id() {
  // @@protoc_insertion_point(field_release:chat_ns.ClientAuthenticationReq.request_id)
...
inline void ClientAuthenticationReq::set_allocated_request_id(std::string* request_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:chat_ns.ClientAuthenticationReq.request_id)
}
...
inline const std::string& ClientAuthenticationReq::session_id() const {
  // @@protoc_insertion_point(field_get:chat_ns.ClientAuthenticationReq.session_id)
...
void ClientAuthenticationReq::set_session_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.session_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:chat_ns.ClientAuthenticationReq.session_id)
}
inline std::string* ClientAuthenticationReq::mutable_session_id() {
  std::string* _s = _internal_mutable_session_id();
  // @@protoc_insertion_point(field_mutable:chat_ns.ClientAuthenticationReq.session_id)
  return _s;
}
...
inline std::string* ClientAuthenticationReq::release_session_id() {
  // @@protoc_insertion_point(field_release:chat_ns.ClientAuthenticationReq.session_id)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:chat_ns.ClientAuthenticationReq.session_id)
}
